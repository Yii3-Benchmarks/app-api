...
bench: ## Run home benchmark. Options: BENCH_NAME="..." MODE=steady|ramp CAPTURE_METRICS=1 RATE=... STAGES=... PREALLOCATED_VUS=... MAX_VUS=... K6_LOG_OUTPUT=none|stderr
...
bench-db: ## Run PostgreSQL benchmark. Options: BENCH_NAME="..." MODE=steady|ramp CAPTURE_METRICS=1 RATE=... STAGES=... PREALLOCATED_VUS=... MAX_VUS=... K6_LOG_OUTPUT=none|stderr
	BASE_URL=http://localhost:9991 \
